...
class Test(XplPlugin):
    ...
    def __init__(self):
        """ Init plugin
        """
        XplPlugin.__init__(self, name='test', test = True, source="domogik-xplgw.gidomogik")

        self.send_xpl(schema = "control.basic", data = {"device" : "xpl-arduino.thermostat", "current" : "1"})
        self.ready()
